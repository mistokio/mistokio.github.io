...
export const translations: Record<Language, Record<string, string>> = {
  hu: {
    ...
    'form.desc': 'Kérjük, töltse ki az alábbi űrlapot a jelentkezéshez. A kitöltött adatok automatikusan megnyitják levelezőprogramját.',
  ...
  en: {
    ...
    'form.desc': 'Please fill out the form below to apply. The data will automatically open your email client.',
  ...
  jp: {
    ...
    'form.title': '申込書',
    'form.desc': '申し込みには以下のフォームに記入してください。入力されたデータでメールソフトが自動的に開きます。',
